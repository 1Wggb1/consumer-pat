        ...
        AbstractIntegrationTestConfiguration
{
        ...
        throws Exception
    {
        ...
        assertEquals( cardRequestDTO.balanceValueCents(), createdConsumerCard.getBalanceCents() );
    ...
    {
        final PersistentConsumer persistentConsumer = createConsumer( "Will", VALID_DOCUMENT_NUMBER_WITHOUT_MASK );
        final PersistentConsumerCard drugStoreCard = createConsumerCard( 44445456L,
            CardEstablishmentType.DRUGSTORE,
            persistentConsumer );
        final PersistentConsumerCard foodCard = createConsumerCard( 123586L,
            CardEstablishmentType.FOOD,
            persistentConsumer );
        final PersistentConsumerCard fuelCard = createConsumerCard( 2224711L,
